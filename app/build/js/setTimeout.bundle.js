...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SetTimeoutContainer = __webpack_require__(330);

	var _SetTimeoutContainer2 = _interopRequireDefault(_SetTimeoutContainer);

	var _setTimeoutReducer = __webpack_require__(332);

	var _setTimeoutReducer2 = _interopRequireDefault(_setTimeoutReducer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var store = (0, _redux.createStore)(_setTimeoutReducer2.default);

	(0, _reactDom.render)(_react2.default.createElement(
	    _reactRedux.Provider,
	    { store: store },
	    _react2.default.createElement(_SetTimeoutContainer2.default, null)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _setTimeoutAction = __webpack_require__(331);
	...
	var SetTimeoutContainer = function (_React$Component) {
	    (0, _inherits3.default)(SetTimeoutContainer, _React$Component);

	    function SetTimeoutContainer() {
	        (0, _classCallCheck3.default)(this, SetTimeoutContainer);

	        var _this = (0, _possibleConstructorReturn3.default)(this, (SetTimeoutContainer.__proto__ || (0, _getPrototypeOf2.default)(SetTimeoutContainer)).call(this));

	        _this.clickHandler = _this.clickHandler.bind(_this);
	        return _this;
	    }

	    (0, _createClass3.default)(SetTimeoutContainer, [{
	        key: 'clickHandler',
	        value: function clickHandler(e) {
	            var _this2 = this;

	            console.log(e);
	            this.props.dispatch((0, _setTimeoutAction.setTimeoutActionCreator)("nothing"));
	            setTimeout(function () {
	                return _this2.props.dispatch((0, _setTimeoutAction.setTimeoutActionCreator)("nothing"));
	            }, 2000);
	        }
	    }, {
	        key: 'render',
...
/***/ function(module, exports) {
	...
	var setTimeoutActionCreator = function setTimeoutActionCreator(info) {
	...
	exports.setTimeoutActionCreator = setTimeoutActionCreator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setTimeoutReducer = function setTimeoutReducer() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState : arguments[0];
	    var action = arguments[1];

	    console.log('pass reducer...action is ' + (0, _stringify2.default)(action));
	    switch (action.type) {
	        case _setTimeoutAction.CLICK_SHOWINFO:
	            return {
	                info: action.info
	            };
	        default:
